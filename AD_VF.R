run_script <- function() {
  ...
  run_last <- function() {
    ...
    url <- "https://www.ouestfrance-immo.com/immobilier/vente/maison/saint-jean-d-angely-17-17347/18494638.htm"
  ...
  formulaire_tcltk <- function() {
    ...
    # Ajouter un titre
    tkgrid(
      tklabel(win, text = "Entrez les informations de votre bien", font = "Helvetica 16 bold", bg = "#f4f4f4", fg = "#333"),
      pady = 20
    )
